    ...
    **backend_properties**       target    backend_properties       backend_properties
    ...
    Args:
        ...
        optimization_method (str): The plugin name to use for the
            ...
            ``stage_name`` argument.
        heuristic (str): Heuristic for dqcmap modified sabre routing.
        sabre_starting_layouts (list): List of layouts as starting layouts for dqcmap layout.
    ...
    if sabre_starting_layouts is not None:
        # if sabre_starting_layouts is set, do not set initial_layout to use initial_layout generated by dqcmap layout
        assert initial_layout is None
